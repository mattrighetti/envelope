...
pub async fn delete_env(pool: &SqlitePool, env: &str) -> Result<()> {
...
pub async fn delete_var_globally(pool: &SqlitePool, key: &str) -> Result<()> {
...
pub async fn delete_var_in_env(pool: &SqlitePool, env: &str, key: &str) -> Result<()> {
